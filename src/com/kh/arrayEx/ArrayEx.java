...
public class ArrayEx {
    ...
    -변수 사용시 저장된 주소로 찾아가서
        ...
        ** 기본 자료형 8개를 제외한 나머지 자료형은 모두 참조형 변수
        기본자료형 : byte short int long boolean float double char
     */
    public void method1(){
        int num;
        // stack 영역에 int 자료형을 저장할 수 있는 변수(공간)을 생성하고
        // 그 변수(공간)의 이름을 num으로 저장
        int[] arr;
        //stack 영역에 변수생성 (주소저장)
        // 변수 이름을 arr 로 지정
    ...
    public void method2(){
        ...
        arr[2] = "css";
        arr[3] = "js";
        // 01 _ 배열 선언, 초기화 전 후 메모리 구조_ String

        String arr2[] = {"java", "html", "css", "js"};
    }
